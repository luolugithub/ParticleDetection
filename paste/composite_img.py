...
background = Image.new('RGB', (500, 382), color='white').convert('RGBA')

foreground1 = Image.open("/home/luolu/PycharmProjects/ParticleDetection/data/image/trans_line_black_pills_02.png").convert('RGBA')
# foreground2 = Image.open("result/mask1Quartz_transparent.png").convert('RGBA')
# foreground3 = Image.open("result/mask1Illite_transparent.png").convert('RGBA')
...
background.save("/home/luolu/PycharmProjects/ParticleDetection/data/image/background_line_pills.png")
background.show()

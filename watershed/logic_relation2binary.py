...
img1 = cv2.imread('/home/luolu/PycharmProjects/ParticleDetection/data/yashi_qscan/Bitwiseand_test.png', 0)
img2 = cv2.imread('/home/luolu/PycharmProjects/ParticleDetection/data/yashi_qscan/wline_test_bw.png', 0)
...
# cv2.namedWindow('test', flags=2)
# cv2.imshow("test", img_bwa)
